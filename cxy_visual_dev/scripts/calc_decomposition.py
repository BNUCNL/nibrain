...
from cxy_visual_dev.lib.predefine import proj_dir,\
    ...
    get_rois, s1200_1096_curv, s1200_1096_va
...
if __name__ == '__main__':
    ...
    decompose_mf(
        ...
        method='PCA', n_component=20, axis='subject', zscore0=None, zscore1='split',
        csv_files=[
            pjoin(work_dir, 'HCPY-MTCV_MMP-vis2-LR_zscore1-split_PCA-subj_M.csv'),
            pjoin(work_dir, 'HCPY-MTCV_MMP-vis2-LR_zscore1-split_PCA-subj_T.csv'),
            pjoin(work_dir, 'HCPY-MTCV_MMP-vis2-LR_zscore1-split_PCA-subj_C.csv'),
            pjoin(work_dir, 'HCPY-MTCV_MMP-vis2-LR_zscore1-split_PCA-subj_V.csv')
        ],
        cii_file=pjoin(work_dir, 'HCPY-MTCV_MMP-vis2-LR_zscore1-split_PCA-subj.dscalar.nii'),
        pkl_file=pjoin(work_dir, 'HCPY-MTCV_MMP-vis2-LR_zscore1-split_PCA-subj.pkl'),
        random_state=7
    )
