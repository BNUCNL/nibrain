...
def weight_CCA_beh(vis_name):
    ...
    # 0. 用上PC2的M和T的权重作为特征（一共2个）
    # 1. 选择晶体和流体认知能力的Unadjusted Scale Score
    n_component = 2
    meas_names = ('M', 'T')
    pc_names = ('C2',)
    beh_cols = ['CogFluidComp_Unadj', 'CogCrystalComp_Unadj']
    # beh_cols = [
    ...
    out_file = pjoin(work_dir, f'weight-CCA-beh_{vis_name}_v10.pkl')
