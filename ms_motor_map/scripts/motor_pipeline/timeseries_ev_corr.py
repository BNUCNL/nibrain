...
if __name__ == '__main__':
    ica_dir = '/nfs/e4/function_guided_resection/MotorMap/data/bold/derivatives/melodic/sub-01/ses-1/run-2.ica'
    events_file = '/nfs/e4/function_guided_resection/MotorMapping/sub-M01/ses-01/func/sub-M01_ses-01_task-motor_run-4_events.tsv'
    target_ev_list = [3, 4]
    figures_dir = '/nfs/e2/workingshop/masai/melodic_test/test1'
